...
def take_img():
    ...
    if enrollment == '' or name == '':
        ...
        detector = cv2.CascadeClassifier(r'C:\Users\SANMITRA\Downloads\Attendance System\AICTE_Internship_Smart_Attendance-master\haarcascade_frontalface_default.xml')
        sampleNum = 0
        while True:
            ret, img = cam.read()
